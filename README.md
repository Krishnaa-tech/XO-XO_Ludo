...
1. When game starts, all pawns are blocked at home, to release pawns, the player must roll 1 or 4 or 8.
...
1. Only one pawn can stand on a square except on a safe square marked with a star. So if Player 1’s pawn stands on a square and Player 2’s pawn is moving to the same square then Player 2 pawn can kill Player 1’s pawn. Then, player 1’s pawn will go back to the starting square and get's blocked again.
